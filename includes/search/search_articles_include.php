...
if ($_GET['stype'] == "articles" || $_GET['stype'] == "all") {
    ...
    if ($rows != 0) {
        $items_count .= THEME_BULLET."&nbsp;"
            ."<a href='".FUSION_SELF."?stype=articles&amp;stext=".$_GET['stext']."&amp;".$composevars."'>"
            .$rows." ".($rows == 1 ? $locale['a401'] : $locale['a402'])." ".$locale['522']
            ."</a><br />\n";
        $result = dbquery(
        ...
        while ($data = dbarray($result)) {
            ...
            $search_result .= "<h4 class='media-heading'>"
                ."<a href='".BASEDIR."readarticle.php?article_id=".$data['article_id']."'>".$data['article_subject']."</a>"
                ."</h4>\n";
            $search_result .= "<div class='media-text' style='width:auto; height:auto; overflow:auto'>\n<p>\n"
                ...
                ." ".$locale['global_071'].showdate("longdate", $data['article_datestamp'])
                ."</span><br />\n<span class='small text-muted'>"
                .$subj_c." ".($subj_c == 1 ? $locale['520'] : $locale['521'])." ".$locale['522']." ".$locale['a404'].", "
                .$text_c." ".($text_c == 1 ? $locale['520'] : $locale['521'])." ".$locale['522']." ".$locale['a405']
                ."</span>\n</div>\n";
            $search_result .= "</div>\n</div>\n<hr />\n";
