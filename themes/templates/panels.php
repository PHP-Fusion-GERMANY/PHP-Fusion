...
if (iADMIN && !defined("ADMIN_PANEL")) {
    ...
    if (!empty($ad_mess)) {
        $admin_mess .= "<div class='admin-message alert alert-warning'>";
...
$admin_mess .= "<noscript><div class='noscript-message admin-message alert alert-danger'>".$locale['global_303']."</div>\n</noscript>\n<!--error_handler-->\n";
